                ...
                child: ZoomIn(
                  ...
                  child: Container(
                    ...
                    child: GetBuilder<MainScreenController>(
                        init:
                            MainScreenController(api: DioConsumer(dio: Dio())),
                        builder: (controller) {
                          return ListView(
                            children: [
                              Padding(
                                padding:
                                    const EdgeInsets.only(top: 30, right: 50),
                                child: Column(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Column(
                                children: [
                                  ...
                                  //         child: Text(
                                  //             "   السعي بين الصفاة و المروة 7 مرات"),
                                  //       ),
                                  //       // const SizedBox(height: 3),
                                  //     ],
                                  //   ),
